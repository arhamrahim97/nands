...
class DataTransaksiController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = DataTransaksi::select('id_transaksi', DB::raw('GROUP_CONCAT(nama_barang ORDER BY id ASC) as nama_barang'), DB::raw("date_format(tanggal,'%d/%m/%Y') as tanggal_"))->groupBy('id_transaksi')->groupBy('tanggal');
            // ->orderBy('tanggal', 'DESC')->orderBy('id_transaksi', 'DESC');
